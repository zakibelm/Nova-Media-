...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onViewChange }) => {
  ...
  return (
    <div className={`w-64 h-screen bg-nova-900 ${direction === 'rtl' ? 'border-l left-auto right-0' : 'border-r left-0'} border-nova-700 flex flex-col fixed top-0 z-50`}>
      <div className="p-6 flex items-center gap-3 border-b border-nova-700/50">
        <div className="w-8 h-8 bg-nova-cyan rounded-md flex items-center justify-center shadow-[0_0_15px_rgba(6,182,212,0.5)] flex-shrink-0">
